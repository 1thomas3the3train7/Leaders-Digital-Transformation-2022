...
import com.example.authservice.Grpc.UserGrpcClient;
...
public class UserService {
    ...
    public UserService(UserGrpcClient grpcClient, DtoUtils dtoUtils, JwtUtils jwtUtils,
                       EmailValidator emailValidator, PasswordEncoder encoder,
    ...
    public String registerAndValid(final String request){
        try {
            ...
            throw new NotValidRequestException("Incorrect email/password/name");
